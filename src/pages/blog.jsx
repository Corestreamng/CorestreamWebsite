    ...
    <motion.div className="relative w-full h-100 bg-gradient-to-br from-slate-50 to-blue-50 overflow-hidden" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6 }}>
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-6 text-center">
            <div className='flex flex-cols gap-4'>
              ...
              <h1 className='text-3xl md:text-7xl font-bold'>Blogs</h1>
            </div>
            <div className='flex flex-col gap-4'>
              <h1 className='text-base md:text-xl tracking-tighter py-8 text-gray-400'>We share expert advice, industry trends, and actionable strategies for</h1>
              <h1 className='text-base md:text-xl tracking-tight text-gray-400 -mt-12'>founders, product professionals, and developers.</h1>
            </div>
